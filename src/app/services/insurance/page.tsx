      ...
      <section className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#FB4D66] font-medium">Insurance</span>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl md:text-6xl font-bold text-[#FB4D66] mb-6">Insurance</h1>
                <p className="text-xl text-gray-700 leading-relaxed">Comprehensive insurance coverage for your domestic worker.</p>
              </div>
              <div><Image src="/about us.avif" alt="Insurance" width={600} height={400} className="rounded-2xl shadow-xl w-full h-auto" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-800 mb-8">FDW Insurance Service</h2>
            <div className="space-y-6 mb-12">
              <p className="text-lg text-gray-700 leading-relaxed">
                As an employer of a Foreign Domestic Worker (FDW) in Singapore, you are required by law to purchase and maintain insurance coverage for your helper. Sweet Home Employment Agency helps you secure comprehensive insurance that meets all MOM requirements.
              </p>
            </div>

            <h3 className="text-3xl font-bold text-gray-800 mb-6">Mandatory Insurance Coverage:</h3>
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                { title: "Medical Insurance", desc: "Minimum $15,000 coverage for inpatient care and day surgery" },
                { title: "Personal Accident", desc: "Minimum $60,000 coverage for death or permanent disability" },
                { title: "Hospitalization", desc: "Coverage for medical expenses during hospitalization" },
                { title: "Surgical Procedures", desc: "Coverage for necessary surgical treatments" },
                { title: "Outpatient Treatment", desc: "Optional coverage for outpatient medical care" },
                { title: "Repatriation", desc: "Coverage for repatriation costs if needed" }
              ].map((item, i) => (
            ...
            <div className="bg-gradient-to-br from-pink-50 to-white p-8 rounded-2xl border border-pink-100 mb-12">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Why Choose Our Insurance Service?</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Competitive premium rates from trusted insurers</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Meets all MOM insurance requirements</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Quick and easy application process</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Comprehensive coverage options available</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Assistance with claims processing</span></li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-12">
              ...
              <ul className="space-y-2 text-gray-700 text-sm">
                <li>• Insurance must be maintained throughout helper's employment</li>
                <li>• Coverage must start from helper's arrival in Singapore</li>
                <li>• Renewal must be done before policy expiry</li>
                <li>• Failure to maintain insurance may result in penalties</li>
              </ul>
            </div>
