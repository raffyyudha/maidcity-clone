...
export default function HomeLeaveProcessing() {
  return (
      ...
      <section className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#FB4D66] font-medium">Home Leave Processing</span>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl md:text-6xl font-bold text-[#FB4D66] mb-6">Home Leave Processing</h1>
                <p className="text-xl text-gray-700 leading-relaxed">Process home leave applications for your domestic worker.</p>
              </div>
              <div><Image src="/about us.avif" alt="Home Leave Processing" width={600} height={400} className="rounded-2xl shadow-xl w-full h-auto" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-800 mb-8">Home Leave Service</h2>
            <div className="space-y-6 mb-12">
              <p className="text-lg text-gray-700 leading-relaxed">
                Your Foreign Domestic Worker (FDW) is entitled to home leave to visit their family in their home country. Sweet Home Employment Agency provides complete assistance with home leave processing to ensure a smooth and hassle-free experience for both you and your helper.
              </p>
            </div>

            <h3 className="text-3xl font-bold text-gray-800 mb-6">Our Home Leave Services:</h3>
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                { title: "Leave Application", desc: "Process home leave application with MOM" },
                { title: "Flight Booking", desc: "Assistance with flight ticket arrangements" },
                { title: "Travel Documentation", desc: "Ensure all travel documents are in order" },
                { title: "Re-entry Permit", desc: "Process Special Pass for helper's return" },
                { title: "Insurance Coverage", desc: "Verify insurance coverage during travel" },
                { title: "Itinerary Planning", desc: "Help plan travel dates and arrangements" }
              ].map((item, i) => (
            ...
            <div className="bg-gradient-to-br from-pink-50 to-white p-8 rounded-2xl border border-pink-100 mb-12">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Home Leave Requirements</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Helper must have worked for at least 6 months</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Valid passport with at least 6 months validity</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Valid work permit</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Employer's consent and approval</span></li>
                <li className="flex gap-3"><CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={20} /><span>Return flight ticket booking</span></li>
              </ul>
            </div>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-12">
              ...
              <ul className="space-y-2 text-gray-700 text-sm">
                <li>• Apply for home leave at least 2 weeks in advance</li>
                <li>• Helper must return within the approved leave period</li>
                <li>• Special Pass required for re-entry to Singapore</li>
                <li>• Ensure insurance coverage is valid during travel</li>
