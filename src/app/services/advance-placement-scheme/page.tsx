...
import { Facebook, Twitter, Linkedin, Mail, Phone, MapPin, CheckCircle2, UserCheck } from 'lucide-react';

export default function AdvancePlacementScheme() {
  return (
      ...
      <section className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-[#FB4D66] font-medium">Advance Placement Scheme (APS)</span>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl md:text-6xl font-bold text-[#FB4D66] mb-6">Advance Placement Scheme (APS)</h1>
                <p className="text-xl text-gray-700 leading-relaxed">
                  Fast deployment scheme facilitated by MOM for better matching of FDWs.
                </p>
              </div>
              <div>
                <Image
                  src="/about us.avif"
                  alt="Advance Placement Scheme"
                  width={600}
                  height={400}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-800 mb-8">What is APS?</h2>
            
            <div className="space-y-6 mb-12">
              <p className="text-lg text-gray-700 leading-relaxed">
                The Advance Placement Scheme (APS) for Foreign Domestic Workers (FDWs) is a scheme facilitated by the Ministry of Manpower (MOM) to enable faster placement and better matching of FDWs for employers with caregiving needs.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Sweet Home Employment Agency is proud to be selected by MOM as an authorized APS agency. This allows us to bring qualified FDWs to Singapore in advance, giving you the opportunity to interview them face-to-face before making your decision.
              </p>
            </div>

            <h3 className="text-3xl font-bold text-gray-800 mb-6">Benefits of APS:</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Meet and interview candidates in person before hiring</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Better Matching</h4>
                  <p className="text-gray-600">Find the perfect helper that fits your family's needs</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Fast Deployment</h4>
                  <p className="text-gray-600">Helper can start work within 3 days after selection</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">MOM Approved</h4>
                  <p className="text-gray-600">Authorized and regulated by Ministry of Manpower</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Pre-Screened Candidates</h4>
                  <p className="text-gray-600">All helpers are thoroughly vetted and trained</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <CheckCircle2 className="text-[#FB4D66] flex-shrink-0 mt-1" size={24} />
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Reduced Risk</h4>
                  <p className="text-gray-600">Lower chance of mismatch with in-person assessment</p>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-pink-50 to-white p-8 rounded-2xl border border-pink-100 mb-12">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">How APS Works</h3>
              <ol className="space-y-4 text-gray-700">
                <li className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold mb-1">Browse Available Helpers</p>
                    <p className="text-sm">View profiles of FDWs currently in Singapore under APS</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <span className="flex-shrink-0 w-8 h-8 bg-[#FB4D66] text-white rounded-full flex items-center justify-center font-bold">2</span>
                  <div>
                    <p className="font-semibold mb-1">Schedule Interview</p>
                    <p className="text-sm">Arrange a face-to-face meeting at our office</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <span className="flex-shrink-0 w-8 h-8 bg-[#FB4D66] text-white rounded-full flex items-center justify-center font-bold">3</span>
                  <div>
                    <p className="font-semibold mb-1">Make Your Decision</p>
                    <p className="text-sm">Choose the helper that best suits your family</p>
                  </div>
                </li>
                <li className="flex gap-4">
                  <span className="flex-shrink-0 w-8 h-8 bg-[#FB4D66] text-white rounded-full flex items-center justify-center font-bold">4</span>
                  <div>
                    <p className="font-semibold mb-1">Quick Deployment</p>
                    <p className="text-sm">Helper starts work within 3 days after approval</p>
                  </div>
                </li>
              </ol>
            </div>
