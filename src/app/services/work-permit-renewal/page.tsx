      ...
      <section className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#FB4D66] font-medium">Work Permit Renewal</span>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-5xl md:text-6xl font-bold text-[#FB4D66] mb-6">Work Permit Renewal</h1>
                <p className="text-xl text-gray-700 leading-relaxed">Hassle-free work permit renewal services for your domestic worker.</p>
              </div>
              <div><Image src="/about us.avif" alt="Work Permit Renewal" width={600} height={400} className="rounded-2xl shadow-xl w-full h-auto" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-800 mb-8">Work Permit Renewal Service</h2>
            <div className="space-y-6 mb-12">
              <p className="text-lg text-gray-700 leading-relaxed">
                Foreign Domestic Worker (FDW) work permits are typically valid for 2 years and must be renewed before expiry. Sweet Home Employment Agency provides complete assistance with the renewal process to ensure your helper can continue working without interruption.
              </p>
            </div>

            <h3 className="text-3xl font-bold text-gray-800 mb-6">Our Renewal Services Include:</h3>
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                { title: "Document Preparation", desc: "Complete all required forms and documentation" },
                { title: "MOM Submission", desc: "Submit renewal application to Ministry of Manpower" },
                { title: "Medical Examination", desc: "Arrange required medical check-ups" },
                { title: "Insurance Renewal", desc: "Update mandatory insurance coverage" },
                { title: "Status Tracking", desc: "Monitor application status and updates" },
                { title: "Expert Guidance", desc: "Professional advice on renewal requirements" }
              ].map((item, i) => (
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-12">
              <h4 className="font-bold text-gray-800 mb-2">Important Reminders:</h4>
              <ul className="space-y-2 text-gray-700 text-sm">
                <li>• Start renewal process at least 1 month before expiry</li>
                <li>• Ensure helper passes medical examination</li>
                <li>• Update insurance coverage before renewal</li>
                <li>• Check that helper's passport is valid for at least 6 months</li>
              </ul>
            </div>
