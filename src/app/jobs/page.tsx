...
import { Facebook, Twitter, Linkedin, Mail, Phone, MapPin, Users, Heart, Briefcase, UserCheck, ArrowRight } from 'lucide-react';
...
export default function Jobs() {
  const jobCategories = [
    {
      ...
      icon: Users,
      description: 'Looking for job as helper? Let us help you find the right employer.',
      link: '/jobs?type=mdw'
    },
    {
      id: 'caregiver',
      title: 'Caregivers',
      icon: Heart,
      description: 'Experienced in caring for elderly? Come join us! We need your help to take care elderly with patient and love.',
      link: '/jobs?type=caregiver'
    },
    {
      id: 'sales',
      title: 'Sales Consultants',
      icon: Briefcase,
      description: 'Looking for flexible working arrangements? Good salary, good commission and nice working environment. Training will be provided for those who do not have any direct experience. We need you.',
      link: '/jobs?type=sales_consultant'
    },
    {
      id: 'customer_care',
      title: 'Customer Care Consultants',
      icon: UserCheck,
      description: 'Join our team as a Customer Care Consultant. Help our clients find the perfect domestic worker for their needs.',
      link: '/jobs?type=customer_care'
    }
  ];
  ...
  const caregiverJobs = [
    {
      id: 5,
      title: 'Looking for Ex-Singapore helpers',
      description: 'We are looking for experienced helpers who have worked in Singapore before.'
    },
    {
      id: 4,
      title: 'Take care of elderly',
      description: 'Seeking compassionate caregivers to take care of elderly patients.'
    }
  ];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/jobs" className="text-[#FB4D66] font-medium border-b-2 border-[#FB4D66] pb-1">Jobs</Link>
      ...
      <section className="bg-gray-50 py-4">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[#FB4D66] font-medium">Jobs</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-pink-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-[#FB4D66] mb-6">Career Opportunities</h1>
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Join Sweet Home</h2>
            <p className="text-lg text-gray-700 leading-relaxed">
              Explore exciting career opportunities with Sweet Home Employment Agency. We're always looking for passionate individuals to join our team.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">What Position Are You Interested In?</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-center">
                    <Link 
                      href={category.link}
                      className="inline-flex items-center gap-2 text-[#FB4D66] font-medium hover:underline"
                    >
                      Find Out More
                      <ArrowRight size={18} />
                    </Link>
          ...
          {/* Featured Caregiver Jobs */}
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-800 mb-8">Featured Caregiver Positions</h3>
            <div className="grid md:grid-cols-2 gap-6">
              {caregiverJobs.map((job) => (
                <div 
                  key={job.id}
                  className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6 border-l-4 border-[#FB4D66]"
                >
                  <h4 className="text-xl font-bold text-gray-800 mb-3">{job.title}</h4>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Ready to Apply?</h2>
            <p className="text-lg text-gray-700 mb-8">
              Please submit the following details to apply for any position. You can contact us at any of our branches or send your application via email.
            </p>
            <Link 
              href="/contact-us"
              className="inline-block bg-[#FB4D66] text-white px-12 py-4 rounded-full hover:bg-[#FB4D66] font-bold text-lg transition"
            >
              Contact Us to Apply
            </Link>
          </div>
